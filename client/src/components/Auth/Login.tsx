  ...
  return (
    <div className="bg-blue-50 h-screen flex">
      <div onClick={auth} className="max-w-md m-auto">
        ...
        <div className="text-xl w-48 items-center content-center font-thin text-gray-800- m-auto px-6 py-2 rounded cursor-pointer border  bg-indigo-600 hover:bg-indigo-700 text-white hover:shadow-xl">
